...
export default function LeadDetailPage() {
  ...
  return (
    <div className="page-container">
      <Link
        href="/leads"
        className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-800 mb-2 w-fit"
      >
        ...
        <div className="space-y-4">
          <div className="card p-6">
            <div className="flex items-center justify-end mb-2">
              <button onClick={openEdit} className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-700">
                <Edit2 size={12} /> Edit
              </button>
            </div>
            <div className="flex flex-col items-center text-center mb-5">
              ...
              <div className="mt-3 relative">
                ...
                {statusOpen && (
                  <div className="absolute left-1/2 -translate-x-1/2 top-full mt-1.5 bg-white border border-gray-200 rounded-xl shadow-xl z-10 py-1 min-w-[180px]">
                    {LEAD_STATUSES.map((s) => (
                      <button
                        key={s}
                        onClick={() => handleStatusChange(s)}
                        className={cn(
                          'w-full text-left px-3.5 py-2 text-sm hover:bg-gray-50 flex items-center gap-2.5',
                          lead.status === s && 'bg-gray-50 font-medium'
                        )}
                      >
                        <span
          ...
          <div className="card p-4">
            ...
            <div className="space-y-2">
              ...
              <Link
                href="/inbox"
                className="flex items-center gap-3 p-3 rounded-xl bg-green-50 text-green-700 hover:bg-green-100 transition-colors text-sm font-medium"
              >
                <MessageSquare size={15} /> Open Chat
              </Link>
              <Link
                href="/appointments"
                className="flex items-center gap-3 p-3 rounded-xl bg-orange-50 text-orange-700 hover:bg-orange-100 transition-colors text-sm font-medium"
              >
                  ...
                  <div
                    className={cn(
                      ...
                      msg.direction === 'outgoing'
                        ...
                        : 'chat-bubble-in text-gray-900 border border-gray-100'
                    )}
                  >
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl animate-slide-up">
            <div className="flex items-center justify-between p-5 border-b border-gray-100">
              ...
              <button onClick={() => setEditOpen(false)} className="p-1.5 rounded-lg text-gray-400 hover:bg-gray-100">
                <X size={18} />
              </button>
            </div>
