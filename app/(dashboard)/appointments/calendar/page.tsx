  ...
  return (
    <div className="page-container">
      <div className="flex items-center justify-between">
        <Link href="/appointments" className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-900">
                  ...
                  {selectedApts.map((apt) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {apt.notes && (
                          <p className="text-xs text-gray-400 mt-2 border-t border-gray-200 pt-2 truncate">
                            {apt.notes}
                          </p>
                        )}
                      </div>
