        ...
        <div className="w-full max-w-2xl">
          ...
          {businesses.length === 0 ? (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
              ...
              <p className="text-gray-600 font-medium mb-1">No businesses yet</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {businesses.map((biz) => (
                <button
                  ...
                  className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-green-200 transition-all p-6 text-left"
                >
                  <div className="flex items-start gap-4 mb-5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-500 text-sm mt-0.5">{biz.industry}</p>
